...
def evaluate_images(image_id, metrics=None, vortex_data=None, api_key=None):
    """
    Evaluate quantitative reasoning images based on specified metrics
    """
    ...
    for metric in metrics:
        if metric == "reasoning_process":
            prompt_text = prompt_reasoning_process_quantitative.format(
                prompt=prompt,
                dimension=dimension,
            ...
            prompt_text = prompt_reasoning_visual_quantitative.format(
                prompt=prompt,
                dimension=dimension,
                keywords=keywords_str,
                target_description=target_description
...
def run_quantitative_evaluation(
    ...
    """
    Run quantitative reasoning evaluation for a specific model and dimension
    """
    metrics = metrics or METRICS
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="VortexBench Quantitative Reasoning Evaluation")
